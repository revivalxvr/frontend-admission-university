...
export const constructCategoryColors = (
  ...
  // Jika colors kosong/undefined, gunakan fallback warna standar
  const palette = colors && colors.length > 0 
    ? colors 
    : ["blue", "cyan", "indigo", "violet", "fuchsia", "pink", "orange"]

  categories.forEach((category, index) => {
    categoryColors.set(category, palette[index % palette.length] as AvailableChartColorsKeys)
  })
        ...
        <ResponsiveContainer className="size-full">
          ...
          >
            ...
            <Pie
              ...
              data={parseData(data, categoryColors, category) as any[]}
              cx="50%"
              cy="50%"
              startAngle={90}
              endAngle={-270}
